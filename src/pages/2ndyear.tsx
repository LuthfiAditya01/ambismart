    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-br from-primary via-primary to-primary-dark">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10 py-12 md:py-20">
          ...
          <div className="inline-block mb-6 md:mb-8">
            <div className="bg-accent text-white px-6 py-3 rounded-full font-bold text-sm sm:text-base shadow-lg animate-pulse">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-4 md:mb-6 leading-tight">
            Merayakan 2 Tahun
            <br />
            <span className="text-accent-light">AmbiSmart</span>
          </h1>
          ...
          <div className="bg-white/10 backdrop-blur-sm border-2 border-accent rounded-2xl p-6 sm:p-8 md:p-10 max-w-4xl mx-auto mb-8 shadow-2xl">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4">English In The Park</h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-100 mb-6 leading-relaxed">
              Bergabunglah dalam sesi belajar bahasa Inggris outdoor yang menyenangkan dan interaktif di taman kota!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <div className="flex items-center gap-2 text-white">
                <span className="text-2xl">📅</span>
                <span className="font-semibold text-sm sm:text-base">TBA</span>
              </div>
              <div className="flex items-center gap-2 text-white">
                <span className="text-2xl">📍</span>
                <span className="font-semibold text-sm sm:text-base">Taman Kota (Lokasi akan diumumkan)</span>
              </div>
              <div className="flex items-center gap-2 text-white">
                <span className="text-2xl">⏰</span>
                <span className="font-semibold text-sm sm:text-base">09:00 - 15:00</span>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <div className="flex gap-4 p-6 bg-gradient-to-br from-accent/10 to-accent-light/10 rounded-xl border-l-4 border-accent">
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-bold text-primary mb-2">100% GRATIS</h3>
                <p className="text-sm sm:text-base text-gray-700">
                  Tidak ada biaya pendaftaran! Ini adalah bentuk apresiasi kami untuk Anda.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 p-6 bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl border-l-4 border-primary">
              <div className="text-3xl flex-shrink-0">🎓</div>
              <div>
                <h3 className="text-lg sm:text-xl font-bold text-primary mb-2">Sertifikat Partisipasi</h3>
                <p className="text-sm sm:text-base text-gray-700">
                  Dapatkan sertifikat resmi dari AmbiSmart sebagai bukti keikutsertaan Anda.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 p-6 bg-gradient-to-br from-accent-red/10 to-accent-red/5 rounded-xl border-l-4 border-accent-red">
              <div className="text-3xl flex-shrink-0">👥</div>
              <div>
                <h3 className="text-lg sm:text-xl font-bold text-primary mb-2">Networking Opportunity</h3>
                <p className="text-sm sm:text-base text-gray-700">
            ...
            <div className="flex gap-4 p-6 bg-gradient-to-br from-accent-light/10 to-accent/5 rounded-xl border-l-4 border-accent-light">
              <div className="text-3xl flex-shrink-0">🌟</div>
              <div>
                <h3 className="text-lg sm:text-xl font-bold text-primary mb-2">Pengalaman Berharga</h3>
                <p className="text-sm sm:text-base text-gray-700">
                  Belajar bahasa Inggris dengan cara yang berbeda dan lebih menyenangkan di outdoor setting.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary via-primary-dark to-primary">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6">Jangan Sampai Kelewatan!</h2>
          <p className="text-base sm:text-lg md:text-xl text-gray-100 mb-8 md:mb-10 leading-relaxed">
            Kuota terbatas hanya untuk 100 peserta pertama. Daftar sekarang dan amankan tempat Anda di acara spesial
            perayaan 2 tahun AmbiSmart!
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            <button className="px-8 sm:px-10 py-4 sm:py-5 bg-accent hover:bg-accent-dark text-white font-bold rounded-lg transition-all shadow-2xl text-base sm:text-lg transform hover:scale-105 w-full sm:w-auto">
              Daftar Sekarang
            </button>
            <button className="px-8 sm:px-10 py-4 sm:py-5 border-2 border-white text-white font-bold rounded-lg hover:bg-white hover:text-primary transition-all text-base sm:text-lg w-full sm:w-auto">
              Info Lebih Lanjut
            </button>
          </div>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-primary mb-4 md:mb-6">Terima Kasih!</h2>
          <p className="text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed max-w-2xl mx-auto">
            Dua tahun ini tidak akan berarti tanpa dukungan dan kepercayaan Anda. Terima kasih telah menjadi bagian
            dari perjalanan AmbiSmart. Mari terus tumbuh bersama menuju kesuksesan akademik yang gemilang! 🚀
          </p>
        </div>
      </section>
    </div>
